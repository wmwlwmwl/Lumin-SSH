...
const (
	aiProviderWebSearchValidationURL           = "https://www.baidu.com"
	aiProviderWebSearchValidationExpectedTitle = "百度"
	aiProviderWebSearchValidationPrompt        = "请访问 https://www.baidu.com,然后只回答这个网站的名称,不要输出任何解释."
