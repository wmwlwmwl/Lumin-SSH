  ...
  lumin: {
    ...
    light: {
      ...
      xterm: {
        ...
        selectionForeground: '#ffffff',
        selectionInactiveBackground: '#2563eb',
        black: '#0a0f1a', red: '#b91c1c', green: '#15803d', yellow: '#b45309',
        blue: '#1d4ed8', magenta: '#7e22ce', cyan: '#0f766e', white: '#475569',
        brightBlack: '#475569', brightRed: '#dc2626', brightGreen: '#16a34a',
        brightYellow: '#9a3412', brightBlue: '#2563eb', brightMagenta: '#9333ea',
  ...
  'tokyo-night': {
    ...
    light: {
      ...
      xterm: {
        ...
        black: '#0c0e18', red: '#b8344e', green: '#286214', yellow: '#b45309',
        blue: '#1d57c4', magenta: '#7a30cb', cyan: '#005b76', white: '#4c566a',
        brightBlack: '#444b6a', brightRed: '#cf2d4c', brightGreen: '#387a21',
        brightYellow: '#9a3412', brightBlue: '#245fcb', brightMagenta: '#8536f5',
        brightCyan: '#007197', brightWhite: '#1f2335',
      },
      container: {
  ...
  catppuccin: {
    ...
    light: {
      ...
      xterm: {
        ...
        brightCyan: '#209fb5', brightWhite: '#2c2f3a',
      },
      container: {
  ...
  dracula: {
    ...
    light: {
      ...
      xterm: {
        ...
        selectionForeground: '#ffffff',
        selectionInactiveBackground: '#7c3aed',
        black: '#0a0a0f', red: '#b91c1c', green: '#15803d', yellow: '#b45309',
        blue: '#6d28d9', magenta: '#be185d', cyan: '#0e7490', white: '#4b5563',
        brightBlack: '#4b5563', brightRed: '#dc2626', brightGreen: '#16a34a',
        brightYellow: '#9a3412', brightBlue: '#5b21b6', brightMagenta: '#9d174d',
        brightCyan: '#007788', brightWhite: '#1f1f2e',
      },
      container: {
        containerBg: '#f4f4f5',
